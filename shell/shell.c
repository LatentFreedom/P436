...
const	struct	cmdent	cmdtab[] = {
	...
	{"date",	  FALSE, xsh_date},
   {"resume_debug",       FALSE, xsh_resume_debug},/* ASSIGNMENT 4 */
   ...
   {"producer-consumer",  FALSE, xsh_producer_consumer},   /* ASSIGNMENT 5 */
   {"readers-writers",    FALSE, xsh_readers_writers},     /* ASSIGNMENT 5 */
   {"dining-philosophers",FALSE, xsh_dining_philosophers}, /* ASSIGNMENT 5 */
	{"ps",		  FALSE, xsh_ps},
